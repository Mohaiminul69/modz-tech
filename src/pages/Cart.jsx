...
import { BUNDLE, DELIVERY_FLAT, FREE_DELIVERY_OVER, computeCartTotals, fmt } from '../utils/cartPricing'
...
const CartLine = ({ line }) => {
  ...
  return (
    ...
    >
      <div className="h-26 w-26 shrink-0 overflow-hidden rounded-2xl border border-white/9 bg-surface-media">
        {product.image ? (
