      ...
      >
        ...
        <div>
          ...
          <p className="mt-4 max-w-[460px] font-body text-[15.5px] leading-relaxed text-snow/62">
            Active noise cancellation that actually cancels, a case that
            lasts the week, and touch controls that don&apos;t fire by
            accident — the earbuds we reach for ourselves.
          </p>
          ...
          <div className="mt-7 grid grid-cols-3 gap-[2px] overflow-hidden rounded-[14px] border border-white/8 bg-white/6">
            {specs.map((spec) => (
              <div
                key={spec.label}
                className="flex flex-col gap-1 bg-surface px-4 py-[18px]"
              >
          ...
          <div className="mt-7 flex flex-wrap items-center gap-5">
            <div className="flex items-baseline gap-2.5">
              <span className="font-heading text-[26px] font-semibold text-snow">
                ৳729
              </span>
              <span className="font-body text-[13px] text-snow/40 line-through">
                ৳990
              </span>
            </div>
