...
import { offers, offersEndDate, type Offer, type OfferIcon } from "@data/offers";

const ICONS: Record<OfferIcon, typeof PiCube> = {
...
const OfferCard = ({ offer }: { offer: Offer }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="font-heading text-[13px] font-semibold text-white sm:text-[17px]">
          {offer.name}
        </div>
        ...
        <div className="font-body text-[11px] text-snow/62 sm:text-[13.5px]">
          ...
          <span className="text-snow/40 line-through">
      ...
      <div className="flex flex-col gap-8 lg:flex-row lg:flex-wrap lg:gap-[clamp(28px,4vw,56px)]">
        ...
        <div className="flex flex-col gap-4.5 lg:max-w-90 lg:flex-1 lg:basis-60 lg:justify-center">
          ...
          <p className="max-w-[290px] font-body text-[14.5px] leading-relaxed text-snow/58">
            Real cuts on a short list of pieces — while stock and the month
            last.
          </p>
